...
final class cookie
{
     ...
     * @return bool whether the cookie header has successfully been sent (and will *probably* cause the client to set the cookie)
     */
    public static function setcookie($name, $value = null, $expiryTime = 0, $path = null, $domain = null, $secureOnly = true, $httpOnly = false, $sameSiteRestriction = self::SAME_SITE_RESTRICTION_LAX)
    {
